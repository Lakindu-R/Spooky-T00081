...
function Home() {
  return (
    ...
    >
      <div className="mx-auto flex  flex-col items-center justify-center px-4 py-8 sm:px-[2vw]">
        <div className="z-10 flex flex-col items-center text-center">
          ...
          <img
            src={Spooky}
            alt="Spooky Monster"
            className="mx-auto absolute bottom-0 mt-[20%] h-auto w-[55vw] max-w-[280px] sm:mt-[20.83%] sm:w-[35vw] lg:w-[20.83vw] xl:w-[18.22vw]"
          />
        </div>
      </div>
    </section>
